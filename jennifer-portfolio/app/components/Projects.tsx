...
const projects = [
  ...
  },
  {
    ...
    problem:
      "A SaaS team needed a Google Docs-style collaborative editing experience for their product documentation platform.",
    solution:
      "Developed a real-time editor with WebSockets and CRDTs for conflict-free collaboration, supporting multiple concurrent users.",
    features: [
    ...
    techStack: ["Next.js", "WebSockets", "Yjs", "PostgreSQL", "Tailwind CSS"],
    image:
